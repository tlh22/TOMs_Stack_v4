...
BEGIN
	...
	FOR site IN SELECT "CarParkID", "Description"
					FROM anpr."CarParks"
					ORDER BY "CarParkID"
	LOOP
	
		RAISE NOTICE '--- Considering car park %...', site."Description";
		...
		LOOP
			...
			AND v1."CarParkID" = site."CarParkID"
			AND v1."MatchedTo" = v2."ID"
			...
			VALUES (site."CarParkID", stime_period."TimePeriodID", total_at_start, total_in, total_out, total_at_end);
...
SELECT c."Description" AS "CarPark", r."SiteID", TO_CHAR(t."StartTime", 'Day') AS "Survey Day", CONCAT(TO_CHAR(t."StartTime", 'HH24:MI'), '-', TO_CHAR(t."EndTime", 'HH24:MI')) AS "TimePeriod",
