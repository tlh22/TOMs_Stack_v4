...
BEGIN
	...
	LOOP
		...
		LOOP
			...
			INSERT INTO "anpr"."ANPRSummaryResults" ("CarParkID", "SiteID", "TimePeriodID", "TotalIn", "TotalOut")
			VALUES (site."CarParkID", site."SiteID", time_period."TimePeriodID", total_in, total_out);
