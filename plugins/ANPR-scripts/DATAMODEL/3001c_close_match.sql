...
BEGIN
    ...
    LOOP
		...
		LOOP
			...
			OR ("Letter2" = obs."DifferentLetterFrom" AND "Letter1" = obs."DifferentLetterTo");
			
			-- RAISE NOTICE '*** Difference: % % - % ...', obs."DifferentLetterFrom", obs."DifferentLetterTo", correct_match;
