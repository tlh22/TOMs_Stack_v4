...
SELECT CONCAT('copy /y ', RiS."Photos_01", ' "../Photos_Suspensions/', a."SectionName", '_', s."BeatTitle", '_', RiS."Photos_01", '"')
...
SELECT CONCAT('copy /y ', RiS."Photos_02", ' "../Photos_Suspensions/', a."SectionName", '_', s."BeatTitle", '_', RiS."Photos_02", '"')
FROM demand."RestrictionsInSurveys" RiS, demand."Surveys" s,
(SELECT su."GeometryID", r."SectionName"
FROM mhtc_operations."RC_Sections_merged" r, mhtc_operations."Supply" su
WHERE r."gid" = su."SectionID"
...
SELECT CONCAT('copy /y ', RiS."Photos_03", ' "../Photos_Suspensions/', a."SectionName", '_', s."BeatTitle", '_', RiS."Photos_03", '"')
FROM demand."RestrictionsInSurveys" RiS, demand."Surveys" s,
(SELECT su."GeometryID", r."SectionName"
FROM mhtc_operations."RC_Sections_merged" r, mhtc_operations."Supply" su
WHERE r."gid" = su."SectionID"
