...
/**
Check to see if the points have been created
**/
...
SELECT b."GeometryID"
FROM highway_assets."SubterraneanFeatures" b
WHERE b.geom_linestring IS NOT NULL
AND b."NrFeatures" > 0
AND "GeometryID" NOT IN (
    SELECT b1."GeometryID"
    FROM highway_assets."SubterraneanFeatures" b1, highway_assets."SubterraneanFeatures" b2
    WHERE b1.geom_linestring IS NOT NULL
    AND b2.geom_point IS NOT NULL
    AND b1."NrFeatures" > 0
    AND ST_Within(b2.geom_point, ST_Buffer(b1.geom_linestring, 0.5))
