...
#Client certificate:
export MY_USER_NAME_FOR_CERT='postgres'

mkdir -p /home/tim/pg_keys/${MY_USER_NAME_FOR_CERT}
cd /home/tim/pg_keys/${MY_USER_NAME_FOR_CERT}
...
#rm client.csr
cp /home/pg_config/pgconf/root.crt .
chown -R tim:qgis_admin /home/tim/pg_keys